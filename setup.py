...
#
setup_keywords['name'] = 'COSLRGs'
setup_keywords['description'] = 'Data and Analysis of ELG CGM'
setup_keywords['author'] = 'Smailagic & Associates'
setup_keywords['author_email'] = 'msmailag@ucsc.edu'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/marijana777/COSLRGs'
#
